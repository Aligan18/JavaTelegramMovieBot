...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="MyTelegramBot1" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" classes.java %CMD_LINE_ARGS%
