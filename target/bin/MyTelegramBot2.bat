...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="MyTelegramBot2" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" src.main.java.classes.java.MyTelegramBot %CMD_LINE_ARGS%
