...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="myTelegramBot" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" classes.classes.java.MyTelegramBot %CMD_LINE_ARGS%
